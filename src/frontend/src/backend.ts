...
export class Backend implements backendInterface {
    ...
    async divide(arg0: number, arg1: number): Promise<number> {
        if (this.processError) {
            try {
                const result = await this.actor.divide(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async divideSafe(arg0: number, arg1: number): Promise<number | null> {
        if (this.processError) {
            try {
                const result = await this.actor.divideSafe(arg0, arg1);
    ...
    async multiply(arg0: number, arg1: number): Promise<number> {
        if (this.processError) {
            try {
                const result = await this.actor.multiply(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async subtract(arg0: number, arg1: number): Promise<number> {
        if (this.processError) {
            try {
                const result = await this.actor.subtract(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
